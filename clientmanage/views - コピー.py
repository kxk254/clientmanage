...
def email_send(request, pk):
    ...
    if request.method == "POST" and request.POST.get("confirm") == "yes":
        ...
        settings.DEFAULT_FROM_EMAIL = formataddr(('紺野|ソリトンキャピタル', 'web@soliton-cm.com'))
        ...
        subject = "新年のご挨拶|あけましておめでとうございます"
    ...
    return render(request, 'clientmanage/confirm_send_email.html', {'client': client})
